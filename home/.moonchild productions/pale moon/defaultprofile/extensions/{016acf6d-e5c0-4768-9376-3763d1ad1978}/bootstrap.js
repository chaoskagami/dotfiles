...
{
  let windowNames = ["abp:filters", "abp:subscriptionSelection", "abp:composer"];
...
function require(module)
{
  ...
  if (!(module in scopes))
  {
    if (module == "info")
    {
      let applications = {"{8de7fcbb-c55c-4fbe-bfc5-fc555c87dbc4}": "PaleMoon", "{aa3c5121-dab2-40e2-81ca-7ea25febc110}": "fennec2", "toolkit@mozilla.org": "toolkit"};
