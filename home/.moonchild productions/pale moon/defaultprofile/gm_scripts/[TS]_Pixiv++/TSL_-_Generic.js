...
TSL.addStyle = function (id, CSS, doc) { TimidScriptLibrary.addStyle(id, CSS, doc); };
//Add JS script to document header. Document can be left empty.
TSL.addScript = function (id, script, doc) { TimidScriptLibrary.addScript(id, script, doc); };
